...
const ContactSection = () => {
  ...
  return (
    <section id="contato" className="section bg-gradient-to-br from-pastel-green/20 via-white to-pastel-yellow/20">
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center mb-16">
          ...
          <p className="max-w-xl mx-auto mt-6 text-muted-foreground">
            Estou sempre aberto a novas oportunidades de trabalho e colaborações interessantes. Entre em contato comigo!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="p-6 rounded-xl bg-white/50 backdrop-blur-sm border border-white/20 shadow-lg transition-transform hover:translate-y-[-5px]">
              ...
              <p className="text-muted-foreground">Goiânia, GO - Brasil</p>
            </div>
            
            <div className="p-6 rounded-xl bg-white/50 backdrop-blur-sm border border-white/20 shadow-lg transition-transform hover:translate-y-[-5px]">
              <h3 className="text-xl font-bold mb-2">Email</h3>
              <a href="mailto:seu@email.com" className="text-muted-foreground hover:text-foreground transition-colors">
                seu@email.com
              </a>
            </div>
            ...
            <div className="p-6 rounded-xl bg-white/50 backdrop-blur-sm border border-white/20 shadow-lg transition-transform hover:translate-y-[-5px]">
              ...
              <a href="tel:+5562992638037" className="text-muted-foreground hover:text-foreground transition-colors">
                +55 (62) 99263-8037
              </a>
            </div>
          </div>
